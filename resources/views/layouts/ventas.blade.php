                ...
                <div class="container">
                    ...
                    <div  class=" nav collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="bar navbar-nav ms-auto" >
                            <li class="nav-item">
                                <a class="te nav-link" href="{{ route('clientes.index') }}">{{ __('Clientes') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="te nav-link" href="{{ route('contactos.index') }}">{{ __('Contactos') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="te nav-link" href="{{ route('costos.index') }}">{{ __('Costos') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="te nav-link" href="{{ route('actividades.index') }}">{{ __('Actividades') }}</a>
                            </li>
                            <!-- Links de Registro -->
                            @guest
                                @if (Route::has('login'))
